...
And       Check 'Dispaly' filter is present
...
Then      'Grid' filter is available on Book Category

Scenario: Verify that user can see 'List' tab on Book Category page
Given     User is on Books Category page
When      User is on Books Category page
And       Check 'List' tab is present
Then      'List' filter is available on Book Category
...
And       Check that 'Name: A to Z' is fiest in order
Then      'Name: A to Z' is first option in order

Scenario: Verify that can see 'Name A to Z' filter is functioning as expected(Note: Products are filtered in alphabetical order)
Given     User is on Books Category page
When      User is on Books Category page
And       Click on 'Sort by' Category page
And      'Name: A to Z' filter
